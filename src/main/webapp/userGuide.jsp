...
<jsp:include page="header.jsp" />
 <link rel="stylesheet" href="template/stylesheets/jquery.tooltip.css" type="text/css" />
    <script type="text/javascript" src="template/javascripts/jquery1.min.js"></script>
    <script type="text/javascript" src="template/javascripts/jquery.tooltip.js"></script>

...
<div class="container_12">	   
	...
	<div style="margin-left:160px;">
		<table id="login">
			<tr>
				<td>
					<s:form action="login" theme="css_xhtml" class="form-2">   
						<h1><span class="log-in">Log in</span> or <span class="sign-up">sign up</span></h1>
						<p class="float">
							<label for="login"><i class="icon-user"></i>Username</label>
							<s:textfield name="username" maxlength="20" id="username" placeholder="Username or email"/>							
						</p>
						<p class="float">
							<label for="password"><i class="icon-lock"></i>Password</label>
							<s:textfield type="password" name="password" maxlength="20" id="username" placeholder="Password" class="showpassword"/>							
						</p>
						<p class="clearfix"> 
